...
public class FacebookDefaultActivity extends ActionBarActivity {
    ...
    private static final String TAG = FacebookDefaultActivity.class.getSimpleName();
    ...
    private FacebookCallback<Sharer.Result> shareCallback = new FacebookCallback<Sharer.Result>() {
        ...
        private void showResult(String title, String alertMessage) {
            new android.app.AlertDialog.Builder(FacebookDefaultActivity.this)
                    .setTitle(title)
